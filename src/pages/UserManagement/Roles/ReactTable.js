...
const SearchTable = () => {
  const searchTable =
    [
      { id: "01", title: "Farmer", action: "01" },
      { id: "02", title: "Distributor ", action: "02" },
      { id: "03", title: "Harvester", action: "03" },
      { id: "04", title: "Technician", action: "04" },
      { id: "05", title: "hatcheries", action: "05" },
      { id: "06", title: "Lab", action: "06" },
    ];
