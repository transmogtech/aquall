...
const SearchTable = () => {
  const searchTable =
    [
      { id: "01", state: "Andhrapradesh", district: "Westgodavari", action: "01" },
      { id: "02", state: "Telangana",  district: "Westgodavari", action: "02" },
      { id: "03", state: "Tamilnadu", district: "Prakasam", action: "03" },
      { id: "04", state: "Andhrapradesh", district: "Prakasam", action: "04" },
      { id: "05", state: "Telangana",  district: "Prakasam", action: "05" },
      { id: "06", state: "Tamilnadu", district: "Prakasam", action: "06" },
      { id: "07", state: "Andhrapradesh", district: "Guntur", action: "07" },
      { id: "08", state: "Telangana",  district: "Prakasam", action: "08" },
      { id: "09", state: "Tamilnadu", district: "Prakasam", action: "09" },
      { id: "10", state: "Tamilnadu", district: "Prakasam", action: "10" },
    ];
      ...
      },
      {
        ...
        cell: (cell) => {
          return (
            ...
            <Link to={`/edit/district/${cell.getValue()}`} className="btn btn-sm btn-warning"><i className='las la-pen'></i></Link>&nbsp;&nbsp;
