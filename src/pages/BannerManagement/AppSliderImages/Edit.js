...
const EditAppSliderImage = (props) => {
                                ...
                                <Card>
                                    ...
                                    <CardFooter>
                                        <div class="d-flex align-items-start gap-3 mt-4">
                                            ...
                                            <Link to="/app-slider-images" className="btn btn-success btn-label right ms-auto nexttab nexttab" ><i className="ri-arrow-right-line label-icon align-middle fs-16 ms-2"></i>Save</Link>
                                        </div>
                                    </CardFooter>
                                </Card>
                            </Col>
...
export default EditAppSliderImage;