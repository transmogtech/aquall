...
const DataTable = ({ changeStatusAppBannerImage, deleteAppBannerImage, getAppBannerImages, appBannerImage: { appbannerimages, loading } }) => {
  ...
  const handleChageStatus = () => {
    changeStatusAppBannerImage(id, selectedSingle, comment);
        ...
        cell: (cell) => {
          return (
            <div>
              ...
              <Link to={`/edit/app-banner-image/${cell.getValue()[0]}`} className="btn btn-sm btn-warning"><i className='las la-pen'></i></Link>&nbsp;&nbsp;
...
DataTable.propTypes = {
  getAppBannerImages: PropTypes.func.isRequired,
  appBannerImage: PropTypes.object.isRequired,
  deleteAppBannerImage: PropTypes.func.isRequired,
}

const mapStateToProps = state => ({
  appBannerImage: state.appBannerImage,
});

export default connect(mapStateToProps, { changeStatusAppBannerImage, deleteAppBannerImage, getAppBannerImages })(DataTable);