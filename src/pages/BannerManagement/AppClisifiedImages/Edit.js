...
const EditAppClassifiedImage = ({ updateAppClassifiedImage, getAppClassifiedImage, appClassifiedImage: { appclassifiedimage, loading } }) => {
    const { id } = useParams();
    console.log(id);
    useEffect(() => {
        getAppClassifiedImage(id);
    }, [getAppClassifiedImage(id)]);
...
export default connect(mapStateToProps, { updateAppClassifiedImage, getAppClassifiedImage })(EditAppClassifiedImage);