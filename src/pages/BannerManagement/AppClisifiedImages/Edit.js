...
const EditAppClasifiedImage = (props) => {
    ...
    document.title = "Edit App Clasified Image | Aquall Admin";
    return (
        <React.Fragment>
            <UiContent />
            <div className="page-content">
                ...
                <Container fluid>
                    <BreadCrumb title="Edit App Clasified Image" pageTitle="App Clasified Image Management" />
                    <Form onSubmit={(e) => { e.preventDefault(); handleSubmit(); return false; }} action="#">
                        <Row>
                            <Col lg={12}>
                                <Card>
                                    <PreviewCardHeader title="Edit App Clasified Image" />
...
export default EditAppClasifiedImage;