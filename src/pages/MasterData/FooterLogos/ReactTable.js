...
const DataTable = ({ changeStatusFooterLogo, deleteFooterLogo, getFooterLogos, footerLogo: { footerlogos, loading } }) => {
  ...
  const handleChageStatus = () => {
    changeStatusFooterLogo(id, selectedSingle);
        ...
        cell: (cell) => {
          return (
            <div>
              ...
              <Link to={`/edit/footer-logo/${cell.getValue()[0]}`} className="btn btn-sm btn-warning"><i className='las la-pen'></i></Link>&nbsp;&nbsp;
...
DataTable.propTypes = {
  getFooterLogos: PropTypes.func.isRequired,
  footerLogo: PropTypes.object.isRequired,
  deleteFooterLogo: PropTypes.func.isRequired,
}
...
export default connect(mapStateToProps, { getFooterLogos, deleteFooterLogo, changeStatusFooterLogo })(DataTable);