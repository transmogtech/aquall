...
const DataTable = ({ changeStatusFeedType, deleteFeedType, getFeedTypes, feedType: { feedtypes, loading } }) => {
  ...
  const handleChageStatus = () => {
    changeStatusFeedType(id, selectedSingle);
        ...
        cell: (cell) => {
          return (
            <div>
              ...
              <Link to={`/edit/feed-type/${cell.getValue()[0]}`} className="btn btn-sm btn-warning"><i className='las la-pen'></i></Link>&nbsp;&nbsp;
...
DataTable.propTypes = {
  ...
  deleteFeedType: PropTypes.func.isRequired,
  changeStatusFeedType: PropTypes.func.isRequired,
}
