        ...
        <Container fluid>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <h5 className="card-title mb-0 float-start">PL Stage Management</h5>
                        ...
                        <Col xxl={12}>
                            ...
                            <Col xxl={12}>
                                <div>
                                    ...
                                    <Input type="text" className="form-control" id="name" placeholder="PL Stage" />
                                </div>
                            </Col>
