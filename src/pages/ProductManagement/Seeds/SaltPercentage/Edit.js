...
const EditSaltPercentage = ({ getCultureTypes, getCompanies, getPlStages, getSaltPercentage, updateSaltPercentage, company: { companies }, cultureType: { culturetypes}, plStage: {plstages}, saltPercentage: { saltpercentage} }) => {
    const { id} = useParams();
    ...
    console.log(saltpercentage);

    const [selectedCultureType, setSelectedCultureType] = useState(saltpercentage.culturetypeId.title);
    const [selectedCompany, setSelectedCompany] = useState(saltpercentage.companyId.name);
    const [selectedPlStage, setSelectedPlStage] = useState(saltpercentage.plstageId.name);
