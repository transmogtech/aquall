...
const SearchTable = () => {
  const searchTable =
    [
      { id: "01", title: "Growth Promoters", order: "1", action: "01" },
      { id: "02", title: "Oxygen Producers", order: "2", action: "02" },
      { id: "03", title: "Soil Treatment", order: "3", action: "03" },
      { id: "04", title: "Feed supplements", order: "4", action: "04" },
    ];
                ...
                <ModalBody>
                    <form action="#">
                        <div className="row g-3">
                            ...
                            <Col xxl={12}>
                                <div>
                                    <label htmlFor="firstName" className="form-label">Sequence</label>
                                    <Input type="number" className="form-control" id="name" placeholder="Name" defaultValue="01" />
                                </div>
                            </Col>
