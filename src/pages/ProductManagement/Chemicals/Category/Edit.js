...
const EditChemicalCategory = ({ updateChemicalCategory, getChemicalCategory, chemicalCategory: { chemicalcategory} }) => {
    const { id } = useParams();
    useEffect(() => {
        getChemicalCategory(id);
    }, []);
...
export default connect(mapStateToProps, { updateChemicalCategory, getChemicalCategory })(EditChemicalCategory);
