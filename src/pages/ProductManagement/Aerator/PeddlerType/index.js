        ...
        <Container fluid>
          ...
          <Row>
            <Col lg={12}>
              <Card>
                <CardHeader>
                  <h5 className="card-title mb-0 float-start">Peddler Types</h5>
                  <div className='float-end'>

                    <Link to="/create-peddler-type" color="success" className="btn btn-success" id="create-btn"><i className="ri-add-line align-bottom me-1"></i> Add</Link>
